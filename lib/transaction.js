...
class NonDelegateAction extends enums_1.Assignable {
}
...
function delegateAction(senderId, receiverId, actions, nonce, blockHeight, keyPair) {
    const publicKey = keyPair.getPublicKey();
    const nonDelegateActions = actions.map((action) => { return new NonDelegateAction({ action }); });
