...
class ActionArraySerde extends enums_1.Assignable {
}
...
function delegateAction(senderId, receiverId, actions, nonce, blockHash, keyPair) {
    const publicKey = keyPair.getPublicKey();
    const action_array_serde = borsh_1.serialize(exports.SCHEMA, new ActionArraySerde({ actions }));
...
function signDelegateActionData(delegateAction, keyPair) {
    const message = borsh_1.serialize(exports.SCHEMA, delegateAction);
